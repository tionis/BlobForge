...
from blobforge.recipe_runtime import marker1_enriched_v1_recipe, mistral_wiki_v3_recipe, mistral_wiki_v10_recipe
...
async def test_admin_console_job_upload_management_and_recoverable_delete(tmp_path):
    ...
    async with httpx.AsyncClient(
        ...
        management = await client.get("/static/management-v12.js")
        ...
        assert "exclusive consumer of this allowance" in root.text
...
async def test_versioned_route_is_recomputed_exact_and_fully_audited(tmp_path):
    ...
    runtime = mistral_wiki_v10_recipe(
        max_pages=100,
        max_cost_usd=1.0,
