    ...
    if args.engine in {
        ...
        recipe_path = (
            ...
            / (
                ...
                if args.engine in {"mistral-wiki-v3", "mistral-wiki-v4", "mistral-wiki-v5", "mistral-wiki-v6"}
                else (
        ...
        if args.engine.startswith("mistral-wiki"):
            ...
            parameters["normalization_profile"] = {
                ...
                "mistral-wiki-v5": "wiki-v4", "mistral-wiki-v6": "wiki-v5",
            }[args.engine]
...
def cmd_recipe_worker(args):
    ...
    from .recipe_runtime import datalab_wiki_v1_recipe, mistral_wiki_v3_recipe, mistral_wiki_v4_recipe, mistral_wiki_v5_recipe, mistral_wiki_v6_recipe
    ...
    try:
        factory = (
            {"v3": mistral_wiki_v3_recipe, "v4": mistral_wiki_v4_recipe, "v5": mistral_wiki_v5_recipe, "v6": mistral_wiki_v6_recipe}[args.mistral_recipe]
...
def main():
    ...
    p_recipe_worker.add_argument("--mistral-recipe", choices=["v3", "v4", "v5", "v6"], default="v6",
                                 help="Mistral post-processing release (default: v6, conflict-aware book hierarchy)")
