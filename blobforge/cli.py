...
def cmd_evaluate_converter(args):
    ...
    provider_engine = {
        ...
        "mistral-wiki-v6": "mistral", "mistral-wiki-v7": "mistral", "mistral-wiki-v8": "mistral", "mistral-wiki-v9": "mistral", "mistral-wiki-v10": "mistral",
    ...
    if args.engine in {
        ...
        "mistral-wiki-v4",
        "mistral-wiki-v5",
        "mistral-wiki-v6", "mistral-wiki-v7", "mistral-wiki-v8", "mistral-wiki-v9", "mistral-wiki-v10",
    }:
        raw_recipe_path = (
        ...
        recipe_path = (
            ...
            / (
                ...
                if args.engine in {"mistral-wiki-v3", "mistral-wiki-v4", "mistral-wiki-v5", "mistral-wiki-v6", "mistral-wiki-v7", "mistral-wiki-v8", "mistral-wiki-v9", "mistral-wiki-v10"}
                else (
        ...
        if args.engine.startswith("mistral-wiki"):
            ...
            parameters["normalization_profile"] = {
                ...
                "mistral-wiki-v5": "wiki-v4", "mistral-wiki-v6": "wiki-v5", "mistral-wiki-v7": "wiki-v6", "mistral-wiki-v8": "wiki-v7", "mistral-wiki-v9": "wiki-v8", "mistral-wiki-v10": "wiki-v9",
            }[args.engine]
...
def cmd_recipe_worker(args):
    ...
    from .recipe_runtime import datalab_wiki_v1_recipe, mistral_wiki_v3_recipe, mistral_wiki_v4_recipe, mistral_wiki_v5_recipe, mistral_wiki_v6_recipe, mistral_wiki_v7_recipe, mistral_wiki_v8_recipe, mistral_wiki_v9_recipe, mistral_wiki_v10_recipe
    ...
    try:
        factory = (
            {"v3": mistral_wiki_v3_recipe, "v4": mistral_wiki_v4_recipe, "v5": mistral_wiki_v5_recipe, "v6": mistral_wiki_v6_recipe, "v7": mistral_wiki_v7_recipe, "v8": mistral_wiki_v8_recipe, "v9": mistral_wiki_v9_recipe, "v10": mistral_wiki_v10_recipe}[args.mistral_recipe]
...
def main():
    ...
    p_recipe_worker.add_argument("--mistral-recipe", choices=["v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10"], default="v10",
                                 help="Mistral post-processing release (default: v9, bounded contents hierarchy)")
