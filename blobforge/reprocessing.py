    ...
    *,
    ...
    with zipfile.ZipFile(parent) as archive:
        ...
        carry_paths = {
            ...
            or (member.get("role") == "extension" and lifecycle.postprocessing_profile in {"wiki-v3", "wiki-v4", "wiki-v5", "wiki-v6", "wiki-v7", "wiki-v8"})
        }
        ...
        if lifecycle.postprocessing_profile not in {"wiki-v3", "wiki-v4", "wiki-v5", "wiki-v6", "wiki-v7", "wiki-v8"}:
